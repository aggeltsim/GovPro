...
class MinInteriorTest {

    private MinInterior instance;
    private final String initialCode = "1007";
    private final String initialName = "Ministry of Interior";
    private final BigDecimal initialAmount = new BigDecimal("3830276000");
	private final String initialForm = "2025";

	@BeforeEach
	void setUp() {
		instance = new MinInterior(initialCode, initialName, initialAmount, initialForm);
	}
	...
	@Test
	void testSetters() {
		final String newName = "Interior Ministry";
		final BigDecimal newAmount = new BigDecimal("26500.00");
	...
	@Test
	void testToExplain() {
		String expected = initialName + " is responsible for public administration,"
